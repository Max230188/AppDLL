...
// событие разрушения формы frmMain
...
begin
  ...
  // если с узлом Node связана кнопка
    ...
    begin
      case Str[i] of
        ...
        begin
          ...
          Inc(j);
          SetLength(Result, j);
          // сохраняем код символа в массиве
...
var
  i, j: Integer;
  OffSet: Integer; // отступ для столбцов StringGrid
  Panel: TPanel;
...
begin
  ...
  // подгоняем размеры StringGrid под новые размеры Panel
...
begin
  ...
  begin
    ...
    // перемещаем данные всех ячеек (после удаляемой) на одну строку вверх
